...
const Skills = () => {
  ...
  return (
    <section>
      <h2 className="text-2xl leading-9 tracking-wide font-heading pb-4 text-left">
        Skills
      </h2>
        ...
        {groups.map((group) => (
          <article key={group.title} aria-labelledby={`skills-${group.title}`}>
            <h3
              ...
              className="text-sm md:text-base tracking-normal leading-4 md:leading-6 pb-1 px-2"
            >
              {group.title}
            </h3>
